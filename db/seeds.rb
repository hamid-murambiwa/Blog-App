...
comment6 = Comment.create(text:'As you can see, the opinions of our clients help us to provide better experiences and grow as a company.', user: third_user, post:post2)